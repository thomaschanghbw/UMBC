   ...
   <>
    ...
    <form className="flex flex-col justify-center w-full" onSubmit>
        <div className="mx-auto">
            ...
            <input type_="text" name="name" value=userName onChange={target => setUserName(target->ReactEvent.Form.target##value)}/>
        </div>
        ...
        <button className="m-auto bg-green-200" type_="submit"> {React.string("submit")} </button> 
    </form>
   </>
}
let default = make;