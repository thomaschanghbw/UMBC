          ...
          <div
            ...
            <form
              ...
              onSubmit={e =>
                onSubmit(
                  e,
                  {name: userName, hobbies: [], status: "searching"},
                )
              }>
              ...
              <div className="text-center">
                <div className="mb-2">
                  {ReasonReact.string("What are your interests?")}
                </div>
                <div
                  className="inline-grid grid-cols-4 gap-3 mb-10 rounded-sm justify-center">
                  <CheckButton interest={js| Reading 📕 |js} />
                  <CheckButton interest={js| Music 🎵 |js} />
                  <CheckButton interest={js| Cooking 🥘 |js} />
                  <CheckButton interest={js| Movies 🎬 |js} />
                  <CheckButton interest={js| Fitness 💪 |js} />
                  <CheckButton interest={js| Pets 🐕 |js} />
                  <CheckButton interest={js| Computers 👩‍💻 |js} />
                  <CheckButton interest={js| Crafts ✂️ |js} />
                </div>
              </div>
              <button
